...
describe('LedgerAccountList Component - REQ-201.2', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    mockedApi.getLedgerAccounts = jest.fn().mockResolvedValue({
  ...
  describe('Data Loading and Display', () => {
    it('shows loading state while fetching ledger accounts', async () => {
      ...
      mockedApi.getLedgerAccounts.mockReturnValue(new Promise(() => {}));
    ...
    it('handles empty ledger accounts list', async () => {
      mockedApi.getLedgerAccounts.mockResolvedValue({ data: { results: [] } });
    ...
    it('handles direct array response format', async () => {
      mockedApi.getLedgerAccounts.mockResolvedValue({ data: mockLedgerAccounts });
  ...
  describe('Error Handling', () => {
    it('handles API errors gracefully', async () => {
      mockedApi.getLedgerAccounts.mockRejectedValue(new Error('Network error'));
    ...
    it('handles malformed API response', async () => {
      mockedApi.getLedgerAccounts.mockResolvedValue({ data: null });
    ...
    it('handles API response without results property', async () => {
      mockedApi.getLedgerAccounts.mockResolvedValue({ data: { accounts: mockLedgerAccounts } });
  ...
  describe('Chart of Accounts Integration', () => {
    ...
    it('handles mixed account types correctly', async () => {
      ...
      mockedApi.getLedgerAccounts.mockResolvedValue({ data: { results: mixedAccounts } });
  ...
  describe('Performance and Large Datasets', () => {
    it('handles large datasets efficiently', async () => {
      ...
      mockedApi.getLedgerAccounts.mockResolvedValue({ data: { results: largeDataset } });
    ...
    it('renders table with many rows efficiently', async () => {
      ...
      mockedApi.getLedgerAccounts.mockResolvedValue({ data: { results: manyAccounts } });
  ...
  describe('Component Integration', () => {
    ...
    it('handles component remounting correctly', async () => {
      ...
      expect(mockedApi.getLedgerAccounts).toHaveBeenCalledTimes(2);
    });
  });
  ...
  describe('Special Characters and Edge Cases', () => {
    it('handles special characters in account names', async () => {
      ...
      mockedApi.getLedgerAccounts.mockResolvedValue({ data: { results: specialAccounts } });
    ...
    it('handles very long account names', async () => {
      ...
      mockedApi.getLedgerAccounts.mockResolvedValue({ data: { results: longNameAccounts } });
    ...
    it('handles missing or null values in accounts', async () => {
      ...
      mockedApi.getLedgerAccounts.mockResolvedValue({ data: { results: incompleteAccounts } });
