...
describe('LedgerAccountForm Component - REQ-201.2', () => {
  ...
  beforeEach(() => {
    ...
    mockApi.createLedgerAccount.mockResolvedValue({
  ...
  describe('Form Validation', () => {
    it('prevents submission with empty required fields', async () => {
      ...
      expect(mockApi.createLedgerAccount).not.toHaveBeenCalled();
  ...
  describe('Chart of Accounts Management', () => {
    it('creates asset account correctly', async () => {
      ...
      await waitFor(() => {
        expect(mockApi.createLedgerAccount).toHaveBeenCalledWith({
          name: 'Cash',
          code: '1000',
          account_type: 'asset'
        });
  ...
  describe('API Integration', () => {
    ...
    it('shows loading state during submission', async () => {
      ...
      mockApi.createLedgerAccount.mockReturnValue(pendingPromise);
    ...
    it('handles API errors gracefully', async () => {
      mockApi.createLedgerAccount.mockRejectedValue(new Error('API Error'));
    ...
    it('handles network errors specifically', async () => {
      mockApi.createLedgerAccount.mockRejectedValue({
  ...
  describe('Callback Integration', () => {
    ...
    it('works without onSuccess callback', async () => {
      ...
      await waitFor(() => {
        expect(mockApi.createLedgerAccount).toHaveBeenCalled();
      });
    });
  });
  ...
  describe('Accessibility', () => {
    ...
    it('provides meaningful error messages', async () => {
      mockApi.createLedgerAccount.mockRejectedValue(new Error('Account code already exists'));
  ...
  describe('Performance and Edge Cases', () => {
    it('handles rapid form submissions gracefully', async () => {
      ...
      await waitFor(() => {
        expect(mockApi.createLedgerAccount).toHaveBeenCalledTimes(1);
      });
    });
