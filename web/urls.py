...
from main.views_richtext import richtext_editor, richtext_submissions, moderate_richtext, richtext_public, notifications
...
urlpatterns = [
    ...
    path('test-forms/', lambda request: render(request, 'test_forms.html'), name='test_forms'),
    path('login/', views.login_view, name='login'),
    path('logout/', views.logout_view, name='logout'),
    path('register/', views.register, name='register'),
    path('password_reset/', RateLimitedPasswordResetView.as_view(template_name='password_reset_form.html'), name='password_reset'),
    ...
    path('thought/moderate/<int:pk>/<str:action>/', moderate_richtext, name='moderate_richtext'),
