...
from .serializers import (
    SavedSearchSerializer, GlobalSearchIndexSerializer, BulkOperationSerializer,
    SearchResultSerializer
)
from .search_service import SearchService, BulkOperationService
        ...
        try:
            if search_type == 'global':
                ...
                for result in results:
                    serialized_results.append(search_service._serialize_search_result(result))
...
class SavedSearchViewSet(viewsets.ModelViewSet):
    ...
    def recent(self, request):
        ...
        recent_searches = self.get_queryset().filter(
    ...
    def popular(self, request):
        ...
        popular_searches = self.get_queryset().filter(
            is_public=True,
            use_count__gt=0
...
class SearchFiltersAPIView(APIView):
    ...
    def get(self, request):
        ...
        filters_config = {
            ...
            'contacts': {
                'text_filters': ['first_name', 'last_name', 'email', 'phone', 'title', 'company'],
                'choice_filters': {},
                'date_filters': ['created_at', 'updated_at'],
                'number_filters': []
            },
            'tasks': {
                ...
                'choice_filters': {
                    ...
                    'task_type': ['call', 'email', 'meeting', 'follow_up', 'research', 'other']
                },
