...
from main.models import Account, Contact, Deal, DealStage, Project
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        deal_stages = [
            DealStage.objects.create(name=name, order=i)
        ...
        in_progress_stages = [
            s for s in deal_stages if s.name not in ["Closed Won", "Closed Lost"]
        ]
        for i in range(5):
        ...
        for _ in range(30):
            ...
            title = task_title_template.format(
